###########################################################################
## Makefile generated for Simulink model 'paceMakerModel_group10'. 
## 
## Makefile     : paceMakerModel_group10.mk
## Generated on : Sun Nov 29 22:34:14 2020
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/paceMakerModel_group10.elf
...
PRODUCT_NAME              = paceMakerModel_group10
MAKEFILE                  = paceMakerModel_group10.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2020a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2020a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/gt-sh/DOCUME~1/School/3RDYEA~1/3K04/ASSIGN~2/CODE_G~1/simulink
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = paceMakerModel_group10_comp.rsp
CMD_FILE                  = paceMakerModel_group10.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/paceMakerModel_group10.elf
...
DEFINES_STANDARD = -DMODEL=paceMakerModel_group10 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/paceMakerModel_group10_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/paceMakerModel_group10_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/paceMakerModel_group10_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/paceMakerModel_group10_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/paceMakerModel_group10_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/paceMakerModel_group10_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


egram_out.o : $(START_DIR)/paceMakerModel_group10_ert_rtw/egram_out.c
	$(CC) $(CFLAGS) -o "$@" "$<"


paceMakerModel_group10.o : $(START_DIR)/paceMakerModel_group10_ert_rtw/paceMakerModel_group10.c
	$(CC) $(CFLAGS) -o "$@" "$<"


paceMakerModel_group10_data.o : $(START_DIR)/paceMakerModel_group10_ert_rtw/paceMakerModel_group10_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
